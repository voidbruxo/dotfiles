...
keys = [
    ...
    Key([mod],"y",lazy.spawn("prime-run kitty ranger"),desc="my file manager"),
    Key([mod],"l",lazy.spawn("prime-run kitty"),desc="kitty terminal"),
...
group_labels = ["", "", "", "", "", "", "", "", "",]
group_layouts = ["bsp", "MonadWide", "columns", "Max", "RatioTile", "Tile", "TreeTab", "bsp", "bsp"]
