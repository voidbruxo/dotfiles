...
globalkeys = gears.table.join(
    ...
    awful.key({},"Print",function () awful.spawn.with_shell("~/.config/screenshot.sh") end),
    awful.key({modkey},"g",function() awful.util.spawn("rofi -show drun") end),
    ...
    awful.key({},"XFaudioMute",function() awful.util.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle") end),
